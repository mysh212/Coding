...
//		if(left!=1&&up!=1) finding(a-1,b-1,c,n);//向左上找
//		if(left!=1&&down!=1) finding(a+1,b-1,c,n);//向左下找
//		if(right!=1&&up!=1) finding(a-1,b+1,c,n);//向右上找
//		if(right!=1&&down!=1) finding(a+1,b+1,c,n);//向右下找 
		return;
	} else {
		return;
	}
